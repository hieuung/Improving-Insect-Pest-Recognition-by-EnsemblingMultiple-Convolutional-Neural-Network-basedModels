...
from mul_scale import multi_scale_Reso
...
def initialize_model(model_name, num_classes, use_pretrained=True, dropout= 0.5, num_fpn_filter= 256):
    ...
    if model_name == "resnet":
        ...
        input_size = 224
    elif model_name == "multi-reso":
        model_ft = multi_scale_Reso(use_pretrained= use_pretrained, num_classes= num_classes, dropout= 0.5)
        input_size = 224
    else:
...
def model_predict_prob(model, dataloader, path_weight_dict= None, device= 'cuda', return_labels= False):
    """
